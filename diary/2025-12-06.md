...
- [C - Odd One Subsequence](https://atcoder.jp/contests/abc429/tasks/abc429_c)
  - WA: https://atcoder.jp/contests/abc429/submissions/71453345
    - counterをlong longにしないといけなかった・・・
  - WA: https://atcoder.jp/contests/abc429/submissions/71453420
    - combinationをlong long にしないといけなかった・・・
  - AC: https://atcoder.jp/contests/abc429/submissions/71453499
- [C - Brackets Stack Query](https://atcoder.jp/contests/abc428/tasks/abc428_c)
  - AC!: https://atcoder.jp/contests/abc428/submissions/71456022
  - 折れ線グラフを考えると分かりやすかったのか！！！（括弧列の基本知識らしい）
  - ![alt text](image.png)
- [B - Reverse Proxy](https://atcoder.jp/contests/abc410/tasks/abc410_b)
  - AC: https://atcoder.jp/contests/abc410/submissions/71460567
- [B - Citation](https://atcoder.jp/contests/abc409/tasks/abc409_b)
  - https://atcoder.jp/contests/abc409/submissions/71491591
...
何も見ないで一からAC出来た！\
上記の2025/10/28の雪辱を果たした！！！！
うれしい！！！！！！！！！！！！！


競プロで必要な能力\
コーディング能力(実装が出来るというレベル)　＆　アルゴリズム能力

良いエンジニアに必要な能力\
コーディング能力(すべてのコードの選択理由を説明できる実装レベル)　＆　アルゴリズム能力

進め方としては下記でいいんじゃなかろうか。自分はまだ、最初のステップかな。
1. コーディング能力(実装が出来るというレベル)
  - APG4bで充分だと思われる
2. アルゴリズム能力
3. コーディング能力(すべてのコードの選択理由を説明できる実装レベル)
  - なぜpush_backではなく文字列結合を使うのか？等　←　これはc++の専門書が必要
