...
// 03:28:00~3:36:00
03:28:00 - 9:42:00= -6:14:00
19:41:00 - 6:14:00 = 13:27:00

13:35:00くらいまではやってるはずなので、8分足して3:26:00
...
- [C - Step](https://atcoder.jp/contests/abc176/tasks/abc176_c)
  - AC: https://atcoder.jp/contests/abc176/submissions/71711156
- [C - Minimum Glutton](https://atcoder.jp/contests/abc364/tasks/abc364_c)
  - AC: https://atcoder.jp/contests/abc364/submissions/71714668
- [014 - We Used to Sing a Song Together](https://atcoder.jp/contests/typical90/tasks/typical90_n)
  - AC!: https://atcoder.jp/contests/typical90/submissions/71715045
- [C - Security 2](https://atcoder.jp/contests/abc407/tasks/abc407_c)
  - AC: https://atcoder.jp/contests/abc407/submissions/71728980
...
### Youtube
- [【高校数学】必要条件と十分条件～具体例で分かりやすく～ 1-17【数学Ⅰ】](https://www.youtube.com/watch?v=wJaK3eRGFZk)
  - 関西人⇒日本人
    - 十分条件か？：関西人という情報だけで、十分日本人だと分かるので十分条件
    - 必要条件か？：関西人かどうかを見極めるときに、少なくとも日本人であるかどうかを見極めるための条件なので○
  - 十分条件
    - 確実に満たす、十分な条件
  - 必要条件
    - 確実に満たせるわけではないけど、少なくとも必要な条件
- [十分条件・必要条件【超わかる！高校数学Ⅰ・A】～授業～論理と集合＃１６](https://www.youtube.com/watch?v=CltFYLDV5sM)
    - <img src="../img/2025-12-14_image-1.png" alt="alt text" width="360" height="180">\
    - AならばBですか？と聞かれたら、Bの中にAが入っているというベン図をイメージする。そのうえでそうなら十分条件
    - 必要条件を考えるときは、ベンズの関係を入れ替えて、Aの中にBが入ってるのを考える
    - <img src="../img/2025-12-14_image-2.png" alt="alt text" width="360" height="180">\


## 感想

NoviStepsの解法別の各タイトルの3Qまでを解くことにしようか\
3QのDifficultyが200~500らしいので\
※出典：[難易度グレード基準.xlsx](https://docs.google.com/spreadsheets/d/1GJbTRRBsoBaY-CXIr3dIXmxkwacV4nHOTOIMCmo__Ug/edit?gid=0#gid=0)

mindmapについては一度諦めた、とはいえ似たようなことはテキストで整理した。\
下記のようなことが書いてある

> ・与えられている数字や文字は二値で表せられるか？⇒ビット演算

あと、とりあえず貪欲法のQ3を3つ何も見ずにAC出来たので、次に問題数が多い「バケット」をやっていく。明示してなかったけど、どのカテゴリでももとりあえずQ3までは解けるようになろうと思っている。

あと、Geminiに解説スライド作ってもらうとだいぶいいのが出来上がる
